...
# ── Start server ──────────────────────────────────────────────────────────────
echo "[Nova Launcher] Starting server..."
...
echo "[Nova Launcher] Opening http://127.0.0.1:1414 ..."
if command -v open &>/dev/null; then
  open "http://127.0.0.1:1414"          # macOS
elif command -v xdg-open &>/dev/null; then
  xdg-open "http://127.0.0.1:1414"     # Linux
else
  echo "[Nova Launcher] Open your browser to: http://127.0.0.1:1414"
fi
